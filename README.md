...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/LLM-Gemini%20%7C%20Chutes.ai-blueviolet?style=flat-square" />
...
│   │   ├── llm-client.ts           # Provider selector (Gemini / Chutes)
...
- Check that you selected the correct provider (Gemini or Chutes.ai)
- Confirm the key is valid in [Google AI Studio](https://aistudio.google.com) or the Chutes dashboard
